...
public class RenapIdentity
{
    ...
    public String GetFirstNames() => FirstName1 + (String.IsNullOrEmpty(FirstName2) ? "" : " " + FirstName2) + (String.IsNullOrEmpty(FirstName3) ? "" : " " + FirstName3);
    public String GetLastNames() => LastName1 + (String.IsNullOrEmpty(LastName2) ? "" : " " + LastName2) + (String.IsNullOrEmpty(LastNameMarried) ? "" : " DE " + LastNameMarried);
    public String GetBirthPlace() => (String.IsNullOrEmpty(BirthCity)? "" : BirthCity + ", ") + (String.IsNullOrEmpty(BirthState)? "" : BirthState + ", ") + BirthCountry;
}
