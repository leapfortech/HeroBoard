...
public class PepIdentity
{
    ...
    public PepIdentity(int id, int identityId, int relationshipTypeId, String relatioshipTypeDescription, int partnershipMotiveId, String partnershipMotiveDescription, String institutionName, int institutionCountryId, String jobTitle, int isForeigner)
    {
        Id = id;
